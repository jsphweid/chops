"""
ATTENTION!!!!
I found this on the internet at http://www.aaronsw.com/2002/html2text/html2text.py , i.e. the late great
Aaron Swartz(!). I modified it very minorly to use `!=` instead of `is not` and `==` instead of `is` i
n a few places so it wouldn't print warnings/errors.
"""
